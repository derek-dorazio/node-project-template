...
The marker line itself (`<!-- riley:findings -->`) is non-negotiable; the table format above is the recommended layout but Riley may use whatever shape best fits the slice.
